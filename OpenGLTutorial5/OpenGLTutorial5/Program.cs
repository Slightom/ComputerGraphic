...
namespace OpenGLTutorial5
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Glut.glutCreateWindow("Cube RGB");
            ...
            cube = new VBO<Vector3>(new Vector3[] {
                ...
                new Vector3(-1, -1, -1), new Vector3(1, -1, -1), new Vector3(1, -1, 1), new Vector3(-1, -1, 1) }); //BOTTON
            cubeColor = new VBO<Vector3>(new Vector3[] {
                new Vector3(1, 0, 0), new Vector3(1, 1, 0), new Vector3(1, 1, 1), new Vector3(1, 0, 1),          //FRONT
                new Vector3(0, 0, 0), new Vector3(0, 1, 0), new Vector3(0, 1, 1), new Vector3(0, 0, 1),          //BACK
                new Vector3(1, 0, 0), new Vector3(0, 0, 0), new Vector3(0, 0, 1), new Vector3(1, 0, 1),          //LEFT
                new Vector3(1, 1, 0), new Vector3(0, 1, 0), new Vector3(0, 1, 1), new Vector3(1, 1, 1),          //RIGHT
                new Vector3(1, 0, 1), new Vector3(1, 1, 1), new Vector3(0, 1, 1), new Vector3(0, 0, 1),          //TOP
                new Vector3(1, 0, 0), new Vector3(1, 1, 0), new Vector3(0, 1, 0), new Vector3(0, 0, 0) });       //BOTTON
